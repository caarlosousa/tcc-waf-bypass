...
ALVO = "http://alb-sg-243851779.us-east-1.elb.amazonaws.com/use-case-sqli-login.php" # Mude para o DNS da AWS depois
NOME_TESTE = "AWS_WAF" # Mude para "AWS_WAF" depois
NUM_REQUISICOES = 30 # 30 já é uma amostra estatística excelente

# A matriz exata de testes que você definiu + pontos de quebra
TAMANHOS_KB = [1, 4, 8, 16]
